    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Laporan Periode') }} - {{ \Carbon\Carbon::parse(request('tanggal_dari'))->format('d M Y') }} s/d {{ \Carbon\Carbon::parse(request('tanggal_sampai'))->format('d M Y') }}
            </h2>
            <div class="flex space-x-2">
                <form action="{{ route('bank-sampah.laporan.periode') }}" method="GET" class="inline">
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900">Transaksi Penyetoran ({{ $penyetoran->count() }})</h3>
            ...
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900">Transaksi Penjualan ({{ $penjualan->count() }})</h3>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
