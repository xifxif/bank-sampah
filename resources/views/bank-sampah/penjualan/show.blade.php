    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('bank-sampah.penjualan.edit', $penjualan) }}" 
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-base font-semibold text-gray-900">{{ $penjualan->no_transaksi }}</p>
                                </div>

                                <div>
                                    <label class="text-sm font-medium text-gray-500">Tanggal Jual</label>
                                    <p class="text-base text-gray-900">{{ $penjualan->tanggal_jual->format('d F Y') }}</p>
                                </div>

                                <div>
                                    <label class="text-sm font-medium text-gray-500">Dicatat Oleh</label>
                                    <p class="text-base text-gray-900">{{ $penjualan->user->name }}</p>
                                </div>

                                <div>
                                    <label class="text-sm font-medium text-gray-500">Bank Sampah</label>
                                    <p class="text-base text-gray-900">{{ $penjualan->bankSampah->nama }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label class="text-sm font-medium text-gray-500">Nama Pembeli</label>
                                    <p class="text-base font-semibold text-gray-900">{{ $penjualan->pembeli }}</p>
                                </div>

                                <div>
                                    <label class="text-sm font-medium text-gray-500">No. Telepon</label>
                                    <p class="text-base text-gray-900">{{ $penjualan->no_telepon_pembeli ?? '-' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
                                ...
                                <p class="text-base font-semibold text-gray-900">{{ $penjualan->jenisSampah->nama_jenis }}</p>
                            </div>

                            <div>
                                <label class="text-sm font-medium text-gray-500">Kategori</label>
                                <p class="text-base text-gray-900">{{ $penjualan->jenisSampah->kategori->nama_kategori }}</p>
                            </div>

                            <div>
                                <label class="text-sm font-medium text-gray-500">Berat</label>
                                <p class="text-base font-semibold text-gray-900">
                                    {{ number_format($penjualan->berat, 2) }} {{ $penjualan->jenisSampah->satuan }}
                                </p>
                            </div>

                            <div>
                                <label class="text-sm font-medium text-gray-500">Harga Jual per {{ $penjualan->jenisSampah->satuan }}</label>
                                <p class="text-base text-gray-900">
                                    Rp {{ number_format($penjualan->harga_jual_per_satuan, 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="p-4 mt-6 border border-green-200 rounded-lg bg-green-50">
                            <div class="flex items-center justify-between">
                                <span class="text-lg font-semibold text-gray-700">Total Nilai Penjualan</span>
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-base text-gray-700">{{ $penjualan->keterangan }}</p>
                    </div>
                    @endif

                    <div class="pt-6 mt-8 border-t border-gray-200">
                        <div class="flex justify-between text-sm text-gray-500">
                            <span>Dibuat: {{ $penjualan->created_at->format('d M Y H:i') }}</span>
                            <span>Diupdate: {{ $penjualan->updated_at->format('d M Y H:i') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end mt-6 space-x-3">
                <form action="{{ route('bank-sampah.penjualan.destroy', $penjualan) }}" 
                      method="POST" 
