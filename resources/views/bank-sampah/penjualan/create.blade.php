    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('bank-sampah.penjualan.store') }}" method="POST" id="formPenjualan">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <input type="date" id="tanggal_jual" name="tanggal_jual" 
                                   value="{{ old('tanggal_jual', date('Y-m-d')) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="pembeli" name="pembeli" value="{{ old('pembeli') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="no_telepon_pembeli" name="no_telepon_pembeli" value="{{ old('no_telepon_pembeli') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex">
                                <input type="number" id="berat" name="berat" step="0.01" value="{{ old('berat') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="harga_jual_per_satuan" name="harga_jual_per_satuan" 
                                   step="0.01" value="{{ old('harga_jual_per_satuan') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3"
                                      class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm @error('keterangan') border-red-500 @enderror">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
