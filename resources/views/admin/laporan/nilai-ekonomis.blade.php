    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.laporan.nilai-ekonomis') }}" class="space-y-4">
            ...
            @if (isset($summary))
                    ...
                    <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">Total Nilai Ekonomis</p>
                ...
                <div class="mb-6 overflow-hidden bg-white shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="mb-4 text-lg font-semibold text-gray-800">Nilai Ekonomis Per Kategori</h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($perKategori as $item)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-sm text-right text-gray-900 whitespace-nowrap">
                                                Rp
                                                {{ $item->total_berat > 0 ? number_format($item->total_nilai / $item->total_berat, 0, ',', '.') : 0 }}
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                ...
                <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="mb-4 text-lg font-semibold text-gray-800">Nilai Ekonomis Per Jenis Sampah</h3>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                ...
                                <tfoot class="bg-gray-50">
                                    <tr>
                                        <td colspan="3"
                                            class="px-6 py-4 text-sm font-bold text-right text-gray-900">TOTAL</td>
                                        ...
                                        <td class="px-6 py-4 text-sm font-bold text-right text-gray-900">
                                            Rp
                                            {{ $summary['total_berat'] > 0 ? number_format($summary['total_nilai'] / $summary['total_berat'], 0, ',', '.') : 0 }}
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
