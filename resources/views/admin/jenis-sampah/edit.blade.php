                    ...
                    <form action="{{ route('admin.jenis-sampah.update', $jenisSampah) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="kode_jenis" id="kode_jenis" value="{{ old('kode_jenis', $jenisSampah->kode_jenis) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_jenis" id="nama_jenis" value="{{ old('nama_jenis', $jenisSampah->nama_jenis) }}" required
                            ...
                            <div>
                                ...
                                <select name="kategori" id="kategori" required
                                    ...
                                    <option value="organik" {{ old('kategori', $jenisSampah->kategori) == 'organik' ? 'selected' : '' }}>Organik</option>
                                    <option value="anorganik" {{ old('kategori', $jenisSampah->kategori) == 'anorganik' ? 'selected' : '' }}>Anorganik</option>
                                    <option value="b3" {{ old('kategori', $jenisSampah->kategori) == 'b3' ? 'selected' : '' }}>B3 (Bahan Berbahaya & Beracun)</option>
                                </select>
                                @error('kategori')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="satuan" id="satuan" required
                                    ...
                                    <option value="kg" {{ old('satuan', $jenisSampah->satuan) == 'kg' ? 'selected' : '' }}>Kilogram (kg)</option>
                                    <option value="pcs" {{ old('satuan', $jenisSampah->satuan) == 'pcs' ? 'selected' : '' }}>Pieces (pcs)</option>
                                    <option value="unit" {{ old('satuan', $jenisSampah->satuan) == 'unit' ? 'selected' : '' }}>Unit</option>
                                </select>
                                @error('satuan')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="harga_standar" id="harga_standar" value="{{ old('harga_standar', $jenisSampah->harga_standar) }}" min="0" step="0.01" required
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="4"
                                class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('keterangan', $jenisSampah->keterangan) }}</textarea>
                        </div>
