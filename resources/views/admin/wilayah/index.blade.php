                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="search" value="{{ request('search') }}"
                                       placeholder="Kode atau nama wilayah..."
                                       class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-xs font-medium tracking-wider text-center text-gray-500 uppercase">Jumlah Bank Sampah</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                        <a href="{{ route('admin.wilayah.edit', $item) }}"
                                           class="mr-3 text-indigo-600 hover:text-indigo-900">
                                            Edit
                                        </a>

                                        <form action="{{ route('admin.wilayah.destroy', $item) }}"
                                              method="POST"
                                              class="inline"
